...
export default function NewCategoryPage() {
  ...
  useEffect(() => {
    if (error) {
      toastApi.error('Error creating category', error);
      clearError();
    }
  }, [error, clearError]);
  ...
  const onSubmit = async (data: CategoryFormData) => {
    ...
    try {
      ...
      toastApi.success('Category created successfully', 'The category has been added to your catalog');
      router.push('/admin/categories');
    } catch (err) {
      console.error('Failed to create category', err);
      toastApi.error('Failed to create category', 'Please try again');
    }
  };
