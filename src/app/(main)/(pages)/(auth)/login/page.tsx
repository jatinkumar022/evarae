...
export default function LoginPage() {
  ...
  const stepItems = [
    {
      key: 'phone' as const,
      label: mode === 'mobile' ? 'Mobile' : 'Email',
      number: 1,
    },
          ...
          <div className="max-w-xl mx-auto">
            <div className="mb-6 text-center">
              ...
              <p className="text-sm text-[oklch(0.55_0.06_15)] font-light">
                Continue with your{' '}
                {mode === 'mobile' ? 'mobile number' : 'email'} and a one-time
                password.
              </p>
            </div>
                ...
                >
                  ...
                  <div className="gap-3 mt-3 flex sm:items-center justify-between flex-col">
                    ...
                    <button
                      onClick={goToOtp}
                      disabled={
                        mode === 'mobile' ? !isValidPhone : !isValidEmail
                      }
