            ...
            <div className="flex flex-wrap items-center justify-between gap-2 sm:gap-0 mb-4">
              ...
              {!isModalOpen && (
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 bg-gradient-to-r from-[oklch(0.66_0.14_358.91)] to-[oklch(0.58_0.16_8)] text-white text-xs sm:text-sm font-medium rounded-xl hover:shadow-lg hover:shadow-[oklch(0.66_0.14_358.91)]/25 transition-all w-full sm:w-auto"
                >
                    ...
                    render={({ field, fieldState }) => (
                      <div>
                        <input
                          ...
                          type="text"
                          autoComplete="name"
                          className={`w-full rounded-xl border border-primary/20 bg-white px-4 py-2 sm:py-3 text-sm focus:border-primary focus:ring-2 focus:ring-primary/20 focus:outline-none transition-colors relative z-10 ${fieldState.error ? 'border-red-300' : ''
                            }`}
                  ...
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <div className="relative">
                        <div className="relative">
                          <Phone className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400  pointer-events-none z-50" />
                          <input
                            {...field}
                            type="tel"
                            onChange={(e) => {
                            ...
                            maxLength={10}
                            className={`w-full rounded-xl border border-primary/20 bg-white pl-10 pr-4 py-2 sm:py-3 text-sm focus:border-primary focus:ring-2 focus:ring-primary/20 focus:outline-none transition-colors relative z-10 ${fieldState.error ? 'border-red-300' : ''
                              }`}
                      ...
                      render={({ field, fieldState }) => (
                        <div>
                          <input
                            ...
                            className={`w-full rounded-xl border border-primary/20 bg-white px-4 py-2 sm:py-3 text-sm text-left tracking-widest font-mono focus:border-primary focus:ring-2 focus:ring-primary/20 focus:outline-none transition-colors relative z-10 ${fieldState.error ? 'border-red-300' : ''
                              }`}
                            placeholder="123456"
                            inputMode="numeric"
                            style={{ WebkitAppearance: 'none' }}
