...
import { chainsProducts } from '@/lib/data/products';
...
export default function GoldChainsPage() {
  const [filteredProducts, setFilteredProducts] = useState(chainsProducts);
    ...
    <>
      ...
      <Container>
        ...
        <div className="font-heading my-6 sm:my-8 md:flex justify-center items-center gap-2 flex-col text-accent">
          <h1 className="text-2xl lg:text-3xl">Gold Chains Collection</h1>
