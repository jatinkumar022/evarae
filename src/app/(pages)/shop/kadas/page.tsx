...
import { kadasProducts } from '@/lib/data/products';
import BannerImage from '../components/Banner';
import { ad, Banner, BannerMobile } from '@/app/assets/Shop-list';
import { ProductCard } from '../components/ProductCard';
import Image from 'next/image';

export default function KadasPage() {
  const [filteredProducts, setFilteredProducts] = useState(kadasProducts);
      ...
      <Container>
        <nav className="py-4 sm:py-6 text-xs sm:text-sm">
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <span className="text-primary-dark cursor-default">Kadas</span>
          </div>
        </nav>
        <div className="font-heading my-6 sm:my-8 md:flex justify-center items-center gap-2 flex-col text-accent">
          <h1 className="text-2xl lg:text-3xl">Kadas Collection</h1>
