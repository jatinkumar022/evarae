...
import { jhumkasProducts } from '@/lib/data/products';
...
export default function JhumkasPage() {
  const [filteredProducts, setFilteredProducts] = useState(jhumkasProducts);
      ...
      <Container>
        <nav className="py-4 sm:py-6 text-xs sm:text-sm">
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <span className="text-primary-dark cursor-default">Jhumkas</span>
          </div>
        </nav>
        <div className="font-heading my-6 sm:my-8 md:flex justify-center items-center gap-2 flex-col text-accent">
          <h1 className="text-2xl lg:text-3xl">Jhumkas Collection</h1>
