...
// Fix addresses route
const addressesRoute = `import { NextResponse } from 'next/server';
...
fs.writeFileSync('src/app/api/account/addresses/route.ts', addressesRoute);
console.log('Fixed addresses route');
